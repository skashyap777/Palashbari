...
class LocalMohilaCommitteeScreen extends StatefulWidget {
  const LocalMohilaCommitteeScreen({super.key});

  @override
  State<LocalMohilaCommitteeScreen> createState() => _LocalMohilaCommitteeScreenState();
}

class _LocalMohilaCommitteeScreenState extends State<LocalMohilaCommitteeScreen> {
  final ApiService _apiService = ApiService();
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  
  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('Local Mohila Committee')!;

...
class APMembersScreen extends StatefulWidget {
  const APMembersScreen({super.key});

  @override
  State<APMembersScreen> createState() => _APMembersScreenState();
}

class _APMembersScreenState extends State<APMembersScreen> {
  final ApiService _apiService = ApiService();
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  
  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('AP Members')!;

...
class SelfHelpGroupsScreen extends StatefulWidget {
  const SelfHelpGroupsScreen({super.key});

  @override
  State<SelfHelpGroupsScreen> createState() => _SelfHelpGroupsScreenState();
}

class _SelfHelpGroupsScreenState extends State<SelfHelpGroupsScreen> {
  final ApiService _apiService = ApiService();
  final TextEditingController _searchController = TextEditingController();
  final ScrollController _scrollController = ScrollController();

  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('Self Help Groups')!;
  ...
  String _getApiKey(String category) {
    ...
    if (category == 'village') return 'village_id';
    return category;
  }

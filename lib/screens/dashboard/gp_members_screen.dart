...
class GPMembersScreen extends StatefulWidget {
  const GPMembersScreen({super.key});

  @override
  State<GPMembersScreen> createState() => _GPMembersScreenState();
}

class _GPMembersScreenState extends State<GPMembersScreen> {
  final ApiService _apiService = ApiService();
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  
  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('GP Members')!;

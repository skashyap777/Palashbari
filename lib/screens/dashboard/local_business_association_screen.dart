...
class LocalBusinessAssociationScreen extends StatefulWidget {
  const LocalBusinessAssociationScreen({super.key});

  @override
  State<LocalBusinessAssociationScreen> createState() => _LocalBusinessAssociationScreenState();
}

class _LocalBusinessAssociationScreenState extends State<LocalBusinessAssociationScreen> {
  final ApiService _apiService = ApiService();
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  
  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('Local Business Association')!;

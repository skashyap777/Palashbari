...
class VillagePradhanScreen extends StatefulWidget {
  const VillagePradhanScreen({super.key});

  @override
  State<VillagePradhanScreen> createState() => _VillagePradhanScreenState();
}

class _VillagePradhanScreenState extends State<VillagePradhanScreen> {
  final ApiService _apiService = ApiService();
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  
  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('Village Pradhan')!;

...
class AshaKarmiScreen extends StatefulWidget {
  const AshaKarmiScreen({super.key});

  @override
  State<AshaKarmiScreen> createState() => _AshaKarmiScreenState();
}

class _AshaKarmiScreenState extends State<AshaKarmiScreen> {
  final ApiService _apiService = ApiService();
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  
  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('ASHA Karmi')!;

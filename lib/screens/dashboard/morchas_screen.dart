...
class MorchasScreen extends StatefulWidget {
  const MorchasScreen({super.key});

  @override
  State<MorchasScreen> createState() => _MorchasScreenState();
}

class _MorchasScreenState extends State<MorchasScreen> {
  final ApiService _apiService = ApiService();
  final TextEditingController _searchController = TextEditingController();
  final ScrollController _scrollController = ScrollController();

  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('Morchas')!;

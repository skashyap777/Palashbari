...
class MandalCommitteeScreen extends StatefulWidget {
  const MandalCommitteeScreen({super.key});

  @override
  State<MandalCommitteeScreen> createState() => _MandalCommitteeScreenState();
}

class _MandalCommitteeScreenState extends State<MandalCommitteeScreen> {
  final ApiService _apiService = ApiService();
  final TextEditingController _searchController = TextEditingController();
  final ScrollController _scrollController = ScrollController();

  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('Mandal Committee')!;

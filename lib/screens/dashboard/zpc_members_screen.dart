...
class ZPCMembersScreen extends StatefulWidget {
  const ZPCMembersScreen({super.key});

  @override
  State<ZPCMembersScreen> createState() => _ZPCMembersScreenState();
}

class _ZPCMembersScreenState extends State<ZPCMembersScreen> {
  final ApiService _apiService = ApiService();
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  
  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('ZPC Members')!;

...
class NamgharMandirsScreen extends StatefulWidget {
  const NamgharMandirsScreen({super.key});

  @override
  State<NamgharMandirsScreen> createState() => _NamgharMandirsScreenState();
}

class _NamgharMandirsScreenState extends State<NamgharMandirsScreen> {
  final ApiService _apiService = ApiService();
  final TextEditingController _searchController = TextEditingController();
  final ScrollController _scrollController = ScrollController();

  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('Namghar & Mandirs')!;

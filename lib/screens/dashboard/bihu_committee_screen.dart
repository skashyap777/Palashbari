...
class BihuCommitteeScreen extends StatefulWidget {
  const BihuCommitteeScreen({super.key});

  @override
  State<BihuCommitteeScreen> createState() => _BihuCommitteeScreenState();
}

class _BihuCommitteeScreenState extends State<BihuCommitteeScreen> {
  final ApiService _apiService = ApiService();
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  
  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('Bihu Committee')!;

...
class PristhaAbhayakScreen extends StatefulWidget {
  const PristhaAbhayakScreen({super.key});

  @override
  State<PristhaAbhayakScreen> createState() => _PristhaAbhayakScreenState();
}

class _PristhaAbhayakScreenState extends State<PristhaAbhayakScreen> {
  final ApiService _apiService = ApiService();
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  
  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('Pristha Ahbayak')!;

...
class VDPMembersScreen extends StatefulWidget {
  const VDPMembersScreen({super.key});

  @override
  State<VDPMembersScreen> createState() => _VDPMembersScreenState();
}

class _VDPMembersScreenState extends State<VDPMembersScreen> {
  final ApiService _apiService = ApiService();
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  
  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('VDP Members')!;

...
class InfluentialPersonScreen extends StatefulWidget {
  const InfluentialPersonScreen({super.key});

  @override
  State<InfluentialPersonScreen> createState() => _InfluentialPersonScreenState();
}

class _InfluentialPersonScreenState extends State<InfluentialPersonScreen> {
  final ApiService _apiService = ApiService();
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  
  final DashboardIcon _dashboardIcon = DashboardConfig.getIconByTitle('Influential Persons')!;

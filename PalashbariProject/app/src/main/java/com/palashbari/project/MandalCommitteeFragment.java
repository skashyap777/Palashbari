...
public class MandalCommitteeFragment extends Fragment implements ConnectivityReceiver.ConnectivityListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_mandal_committee, container, false);
    ...
    public void onConnectivityChanged(boolean isConnected) {
        if (isConnected) {
            ...
            if (!isAPICallRunning) {
                ...
                AsyncTaskMandal asyncTaskMandal = new AsyncTaskMandal(parameter);
    ...
    public class AsyncTaskMandal extends AsyncTask<Void, Void, Void> {
        ...
        public AsyncTaskMandal(Map<String, String> parameter) {
            this.parameter = parameter;
        }

        @Override
        protected Void doInBackground(Void... voids) {
            JsonAPICall.makePostRequestWithTokenAndFormData(getActivity(),  API.mandal_pagination, parameter, new JsonAPICall.VolleyCallback() {
                @Override
    ...
    private void processValue(JSONArray jsonArray) throws JSONException {
       for (int k = 0; k < jsonArray.length(); k++) {
            ...
            String mandalName = json.getString("name");
            ...
            if (getActivity() != null) {
                ...
                mandalNameTextview.setText(mandalName);
                ...
                mainCardLayout.setOnClickListener(v -> {
                    ...
                    bundle.putString("mandalId", String.valueOf(id));

...
public class SHGFragment extends Fragment implements ConnectivityReceiver.ConnectivityListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_s_h_g, container, false);
    ...
    public void onConnectivityChanged(boolean isConnected) {
        if (isConnected) {
            ...
            if (!isAPICallRunning) {
                ...
                AsyncTaskBlock asyncTaskBlock = new AsyncTaskBlock(parameter);
                asyncTaskBlock.execute();
    ...
    public class AsyncTaskBlock extends AsyncTask<Void, Void, Void> {
        Map<String, String> parameter;

        public AsyncTaskBlock(Map<String, String> parameter) {
    ...
    private void processValue(JSONArray jsonArray) throws JSONException {
        for (int k = 0; k < jsonArray.length(); k++) {
            ...
            String blockName = json.getString("name");
            ...
            if (getActivity() != null) {
                ...
                mandalNameTextview.setText(blockName);
                ...
                mainCardLayout.setOnClickListener(v -> {
                    ...
                    selectedBlockName = mandalNameTextview;
                    selectedImageView = imageView;

                    Fragment newFragment = new SHGDetailsFragment();

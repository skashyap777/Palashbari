...
public class MandirFragment extends Fragment implements ConnectivityReceiver.ConnectivityListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_mandir, container, false);
    ...
    public void onConnectivityChanged(boolean isConnected) {
        if (isConnected) {
            ...
            if (!isAPICallRunning) {
                ...
                parameter.put("type", "mandir");
                parameter.put("gaon_panchayat", selectedPanchayat != null ? selectedPanchayat : "");

                AsyncTaskMandir asyncTaskMandir = new AsyncTaskMandir(parameter);
                asyncTaskMandir.execute();
    ...
    public class AsyncTaskMandir extends AsyncTask<Void, Void, Void> {

        Map<String, String> parameter;


        public AsyncTaskMandir(Map<String, String> parameter) {
    ...
    private void processValue(JSONArray jsonArray) throws JSONException {
        for (int k = 0; k < jsonArray.length(); k++) {
            ...
            String mandirName = json.getString("name");
            String address = "";
            ...
            if (getActivity() != null) {
                ...
                nameTextview.setText(mandirName);
